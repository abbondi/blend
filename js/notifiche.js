...
function registerPushwooshIOS() {
	...
	pushNotification.registerDevice({alert:true, badge:true, sound:true, pw_appid:"5A327-A9ADD", appname:"Blend Crew"},
									function(status) {
...
function registerPushwooshAndroid() {
	...
	pushNotification.registerDevice({ projectid: "367600991568", appid : "5A327-A9ADD" },
									function(token) {
										//alert(token);
